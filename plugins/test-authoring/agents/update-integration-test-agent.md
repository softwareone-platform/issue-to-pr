...
- Authentication setup must be updated when the underlying policy changes — read the source's current authorization attributes and match the identity helpers the sibling tests use.
