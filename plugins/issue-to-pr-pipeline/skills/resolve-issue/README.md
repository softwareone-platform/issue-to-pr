...
- **b-write-tests** — asks when the right test type or scope is genuinely unclear rather than guessing, and surfaces any quality flag its test verifier raises for you to disposition. (It also notes Gherkin scenario coverage as a human follow-up when it looks needed — a report, not a question: nothing waits on it.)
